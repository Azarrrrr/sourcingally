...
category: "Échantillons et développement produit"
tags: ["emballage produit", "marque privée", "sourcing en Chine", "cartons", "approbation d’échantillon"]
...
Reliez un nouveau produit au [guide des échantillons](/fr/product-samples/). Pour la vérification finale, utilisez le [plan de contrôle qualité](/fr/quality-control-plan/). Avant le départ des marchandises, transférez les données de carton et de marquage vers la [préparation de l’expédition](/fr/shipping-readiness/).
