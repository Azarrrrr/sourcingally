...
category: "Primeira importação"
tags: ["ordem de compra", "sourcing na China", "cotação", "sinal", "especificação do produto"]
...
Para revisar o fornecedor antes de pagar, consulte a [verificação de fornecedor](/pt/supplier-verification/). Para a revisão física do produto, use a [guia de amostras](/pt/product-samples/). Antes da entrega, conecte o mesmo registro à [preparação para envio](/pt/shipping-readiness/).
