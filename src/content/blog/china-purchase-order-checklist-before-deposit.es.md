...
category: "Primeras importaciones"
tags: ["orden de compra", "sourcing en China", "cotización", "anticipo", "especificación de producto"]
...
Para revisar hechos del proveedor antes de pagar, abra la [guía de verificación de proveedores](/es/supplier-verification/). Si aún debe revisar el producto físico, use la [guía de muestras](/es/product-samples/). Antes de la entrega, conecte el mismo registro con la [preparación del envío](/es/shipping-readiness/).
