...
tags: ["supplier changes", "sample approval", "China sourcing", "product specification", "production control"]
...
| Change area | Useful question |
| --- | --- |
| Material or component | What is changing, why, and how does the alternative differ in grade, source, colour, function, durability, or appearance? |
| Dimension or construction | Which drawing, measurement, tool, mould, or assembly detail changes? |
| Packaging | Does the change affect the selling box, label, insert, carton count, carton size, protection, or shipping mark? |
| Price | Which item or assumption changed? Is the change per unit, per order, or related to quantity, tooling, freight, or packaging? |
| Timing | What event moved the date? Does it affect sample review, production, inspection, cargo readiness, or shipment booking? |
